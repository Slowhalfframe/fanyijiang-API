...
urlpatterns = [
    ...
    url(r"^api/v2/labels/", include("apps.labels.urls", namespace="labels")),
    url(r"^api/v2/questions/", include("apps.questions.urls", namespace="questions")),
    ...
    url(r"^api/v2/articles/", include("apps.articles.urls", namespace="articles")),
    url(r"^api/v2/pins/", include("apps.pins.urls", namespace="pins")),
    url(r"^api/v2/userpage/", include("apps.userpage.urls", namespace="userpage")),
    url(r"^api/v2/creator/", include("apps.creator.urls", namespace="creator")),
    url(r"^api/v2/notifications/", include("apps.notifications.urls", namespace="notifications")),
