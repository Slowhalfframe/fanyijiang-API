...
from apps.search_v2.serializers import UniformIndexSerializer, UserIndexSerializer
from apps.userpage_v2.models import UserProfile
from apps.userpage_v2.serializers import UserPageArticleSerializer, UserPageThinksSerializer, \
